...
export default function KangenWaterPage() {
  return (
    <div style={{ background: "#040d14" }} className="min-h-screen">
        ...
        <div className="relative max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <SectionReveal>
            <div className="flex items-center gap-3 mb-6">
              ...
              <span className="text-[10px] font-black tracking-[0.4em] uppercase" style={{ color: "#00c8dc" }}>Alkaline Science</span>
            </div>
            <h1 className="text-5xl sm:text-6xl font-black leading-tight tracking-tight text-white mb-6">
              The Secret Behind<br /><span style={{ color: "#00c8dc" }}>Our Taste</span>
            </h1>
            <div className="w-8 h-[2px] rounded-full mb-7" style={{ background: "#00c8dc" }} />
            <p className="text-base leading-[1.85] mb-10" style={{ color: "rgba(255,255,255,0.50)" }}>
            ...
            <Link href="/menu"
              ...
              style={{ background: "rgba(0,200,220,0.10)", border: "1px solid rgba(0,200,220,0.30)", color: "#fff", backdropFilter: "blur(12px)" }}>
          ...
          <SectionReveal delay={0.2}>
            ...
            <div className="relative h-[420px] rounded-3xl overflow-hidden flex items-center justify-center"
                 style={{ background: "rgba(0,200,220,0.05)", border: "1px solid rgba(0,200,220,0.12)" }}>
              ...
              <div className="relative text-center p-8">
                ...
                <div className="w-8 h-[1px] mx-auto mb-3" style={{ background: "#00c8dc" }} />
                <h3 className="text-xl font-black text-white mb-2">Kangen Water</h3>
                <p className="text-sm" style={{ color: "rgba(255,255,255,0.35)" }}>pH 8.5 – 9.5 Alkaline</p>
              </div>
            </div>
          </SectionReveal>
        </div>
        ...
        <div className="max-w-7xl mx-auto">
          <SectionReveal className="mb-16">
            <div className="flex items-center gap-3 mb-5">
              <div className="w-8 h-px" style={{ background: "#00c8dc" }} />
              <span className="text-[10px] font-black tracking-[0.4em] uppercase" style={{ color: "#00c8dc" }}>Why It Matters</span>
            </div>
            <h2 className="text-4xl sm:text-5xl font-black text-white">
              The <span style={{ color: "#00c8dc" }}>Benefits</span>
            </h2>
          </SectionReveal>
            ...
            {benefits.map((b, i) => (
              <SectionReveal key={i} delay={i * 0.1}>
                <div className="group relative rounded-2xl p-8 transition-all duration-300 hover:-translate-y-0.5"
                     style={{ background: "rgba(0,200,220,0.04)", border: "1px solid rgba(0,200,220,0.10)" }}>
                  <div className="absolute inset-0 rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none"
                       style={{ background: "radial-gradient(circle at top left, rgba(0,200,220,0.08), transparent 60%)" }} />
                  <div className="text-[3.5rem] font-black mb-3 select-none" style={{ color: "rgba(0,200,220,0.12)" }}>{b.n}</div>
                  <div className="w-6 h-[1px] mb-3" style={{ background: "#00c8dc" }} />
                  <h3 className="text-lg font-black text-white mb-2">{b.title}</h3>
                  <p className="text-sm leading-relaxed" style={{ color: "rgba(255,255,255,0.40)" }}>{b.body}</p>
                </div>
              </SectionReveal>
            ))}
          </div>
      ...
      {/* CTA */}
      <section className="py-20 px-6 sm:px-10 text-center relative overflow-hidden">
        <div className="absolute inset-0 pointer-events-none"
        ...
        <SectionReveal className="relative max-w-2xl mx-auto">
          <h2 className="text-4xl sm:text-5xl font-black text-white mb-5">
            Experience "The&nbsp;<span style={{ color: "#00c8dc" }}>Kangen Twist</span>"
          </h2>
          ...
          <Link href="/menu"
            ...
            style={{ background: "#00c8dc", color: "#040d14" }}>
            Browse Our Menu →
          </Link>
        </SectionReveal>
      </section>
