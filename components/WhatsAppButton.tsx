...
export default function WhatsAppButton() {
  const waUrl = `https://wa.me/${siteInfo.whatsappNumber}?text=${encodeURIComponent(
    "Hello Kangen Burgers! I'd like to order."
  )}`;
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div
          ...
          style={{
            ...
            borderTop: "6px solid rgba(15,10,8,0.95)",
          }}
        />
      </div>
      ...
      <a
        ...
        className="wa-pulse relative w-14 h-14 sm:w-16 sm:h-16 rounded-full flex items-center justify-center
